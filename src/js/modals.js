  ...
  modalControls.addEventListener("click", (event) => {
    ...
    if (eventId === "cancel-modal") {
      ...
      document.querySelector(
        `div#${projects[activeProject()].id} > .iconHolderSpan`
      ).textContent = iconInput.value;
      document.querySelector(
        `div#${projects[activeProject()].id} > .textHolderSpan`
...
function editTaskModal(id) {
  ...
  if (taskParent.querySelector(".priority-preview").textContent === "Low") {
    ...
    taskParent.querySelector(".priority-preview").textContent === "Medium"
  ) {
    mediumP.setAttribute("selected", "selected");
  } else if (
    taskParent.querySelector(".priority-preview").textContent === "High"
  ) {
  ...
  editTaskModal.addEventListener("click", (event) => {
    ...
    if (eventId === "cancel-modal") {
      ...
      projects[activeProject()].tasks[activeTaskIndex].description =
        descriptionArea.value;
      projects[activeProject()].tasks[activeTaskIndex].priority =
...
function addTaskModal() {
  ...
  modalControls.addEventListener("click", (event) => {
    ...
    if (eventId === "cancel-modal") {
      ...
      projects[activeProject()].addTask(
        new Task(
      ...
      displayTask(
        projects[activeProject()].tasks[
          projects[activeProject()].tasks.length - 1
        ],
        projects[activeProject()].id
      );
      displayMainContent();
